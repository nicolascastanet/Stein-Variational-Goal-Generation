...
```
pytest tests
PYTHONPATH=./ python experiments/svgg/train_svgg.py --env FetchReach-v1 --layers 256 256 --max_steps 5000
```
...
- Stein Variational Goal Generation For Reinforcement Learning in Hard Exploration Problems (Preprint, [Arxiv](https://arxiv.org/abs/2206.06719))
